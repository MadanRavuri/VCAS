                ...
                <div className="p-4 bg-white/5 border-t border-white/10 backdrop-blur-md">
                    ...
                    >
                        <input
                            ...
                            className="flex-1 bg-white/10 border border-white/20 rounded-full px-4 py-2.5 text-white placeholder-gray-400 focus:outline-none focus:border-primary focus:bg-white/20 transition-all text-sm"
                        />
                        <button
                            type="submit"
